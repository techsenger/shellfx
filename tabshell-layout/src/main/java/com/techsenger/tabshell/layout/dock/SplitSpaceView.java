...
public class SplitSpaceView<T extends SplitSpaceViewModel> extends AbstractPaneView<T> {
    ...
    void updateDividersOnHalfSplit(int splitContainerIndex, double[] oldPositions) {
        ...
        logger.debug("Updated dividers on half split; oldPositions: {}, newPositions: {}", oldPositions, newPositions);
    }
    ...
    void updateDividersOnThirdSplit(int splitContainerIndex, double[] oldPositions, Side side) {
        ...
        getNode().setDividerPositions(newPositions);
        logger.debug("Updated dividers on third split; oldPositions: {}, newPositions: {}", oldPositions, newPositions);
    }
    ...
    void updateDividersOnInsertBetween(int newContainerIndex,
        ...
        getNode().setDividerPositions(newPositions);
        logger.debug("Updated dividers on insert between; oldPositions: {}, newPositions: {}", oldPositions,
                newPositions);
    }
     ...
     */
    void updateDividersOnRemoveWithMain(double oldSize, double[] oldPositions, int flexibleChildIndex,
        ...
        logger.debug("Updated dividers on remove with main; oldSize: {}, newSize: {}, flexibleChildIndex: {}, "
                + "removedChildIndex: {}, oldPositions: {}, newPositions: {}",
     ...
     * @param removedChildIndex index of the node that will be removed
     */
    void updateDividersOnRemoveWithoutMain(double oldSize, double[] oldPositions, int removedChildIndex) {
        // Calculate original node sizes in absolute units
        int oldNodeCount = oldPositions.length + 1;
        double[] oldSizes = new double[oldNodeCount];
