...
public class DataInspectorViewModel extends AbstractTabViewModel {
    ...
    private final ObservableList<TypeItem<?>> typeItems = FXCollections.observableArrayList(
            new TypeItem<Long>(1, "Signed Int 8", (v) -> v.getSignedInt8(), NumberBaseConverters::convert),
            new TypeItem<Long>(1, "Unsigned Int 8", (v) -> v.getUnsignedInt8(), NumberBaseConverters::convert),
            new TypeItem<Long>(2, "Signed Int 16", (v) -> v.getSignedInt16(), NumberBaseConverters::convert),
            new TypeItem<Long>(2, "Unsigned Int 16", (v) -> v.getUnsignedInt16(), NumberBaseConverters::convert),
            new TypeItem<Long>(3, "Signed Int 24", (v) -> v.getSignedInt24(), NumberBaseConverters::convert),
            new TypeItem<Long>(3, "Unsigned Int 24", (v) -> v.getUnsignedInt24(), NumberBaseConverters::convert),
            new TypeItem<Long>(4, "Signed Int 32", (v) -> v.getSignedInt32(), NumberBaseConverters::convert),
            new TypeItem<Long>(4, "Unsigned Int 32", (v) -> v.getUnsignedInt32(), NumberBaseConverters::convert),
            new TypeItem<Long>(6, "Signed Int 48", (v) -> v.getSignedInt48(), NumberBaseConverters::convert),
            new TypeItem<Long>(6, "Unsigned Int 48", (v) -> v.getUnsignedInt48(), NumberBaseConverters::convert),
            new TypeItem<Long>(8, "Signed Int 64", (v) -> v.getSignedInt64(),
                    (v, s) -> NumberBaseConverters.convert(v, s)),
            new TypeItem<BigInteger>(8, "Unsigned Int 64", (v) -> v.getUnsignedInt64(), NumberBaseConverters::convert),
            new TypeItem<Float>(4, "Float 32", (v) -> v.getFloat32()),
            new TypeItem<Double>(8, "Float 64", (v) -> v.getFloat64()),
            new TypeItem<Character>(1, "Char 8", (v) -> v.getChar8(), (v, s) -> NumberBaseConverters.convert(v)),
            new TypeItem<Character>(2, "Char 16", (v) -> v.getChar16(), (v, s) -> NumberBaseConverters.convert(v)),
            new TypeItem<String>("UTF 8", (v) -> v.getUtf8Char(), NumberBaseConverters::convert,
                    (v) -> v.getUtf8Length()),
            new TypeItem<String>("UTF 16", (v) -> v.getUtf16Char(), NumberBaseConverters::convert,
                    (v) -> v.getUtf16Length()),
            new TypeItem<String>(4, "UTF 32", (v) -> v.getUtf32Char(), NumberBaseConverters::convert)
    );
