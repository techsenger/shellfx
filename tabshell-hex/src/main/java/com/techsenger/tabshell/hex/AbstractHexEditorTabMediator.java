 ...
 */
public abstract class AbstractHexEditorTabMediator<T extends AbstractHexEditorTabView<?>> extends WorkerTabMediator<T>
        implements StandardDialogMediator {

    public AbstractHexEditorTabMediator(T view) {
        super(view);
    }
