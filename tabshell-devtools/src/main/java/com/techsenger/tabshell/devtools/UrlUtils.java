...
import com.techsenger.tabshell.devtools.node.PropertyItem;
...
public final class UrlUtils {
    ...
    public static String getFieldJavadocUrl(PropertyItem item) {
        return BASE_URL + "search.html?q=" + item.getAttribute().name();
    }
