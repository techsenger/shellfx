...
public interface FileMenuKeys {
    ...
    MenuItemKey OPEN = new MenuItemKey();

    MenuItemKey SAVE = new MenuItemKey();

    MenuItemKey SAVE_AS = new MenuItemKey();

    MenuItemKey EXIT = new MenuItemKey();
}
