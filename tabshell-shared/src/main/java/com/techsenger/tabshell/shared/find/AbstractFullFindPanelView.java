 ...
 */
public abstract class AbstractFullFindPanelView<T extends AbstractFullFindPanelViewModel<?>,
        S extends AbstractFullFindPanelComponent<?>> extends AbstractNavigableFindPanelView<T, S> {
    ...
    public AbstractFullFindPanelView(T viewModel) {
        super(viewModel);
    }
    ...
    protected void build() {
        super.build();
        var css = AbstractFullFindPanelView.class.getResource("find.css").toExternalForm();
    ...
    protected void bind() {
        ...
        ButtonUtils.bind(this.wholeWordButton, viewModel.getWholeWord());
        ButtonUtils.bind(this.regExpButton, viewModel.getRegExp());
        ButtonUtils.bind(this.highlightButton, viewModel.getHighlight());
    }
