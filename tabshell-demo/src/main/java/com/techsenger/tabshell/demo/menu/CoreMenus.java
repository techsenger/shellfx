 ...
 */
public interface CoreMenus {

    MenuName DEMO = new MenuName();

    MenuGroupName ONE = new MenuGroupName("One");

    MenuGroupName TWO = new MenuGroupName("Two");

    MenuItemName NEW = new MenuItemName(); //group 1

    MenuItemName EXIT = new MenuItemName(); //group 2
}
