 ...
 */
public final class ExtraMenu {

    public static final MenuName NAME = new DefaultMenuName();

    public static final MenuGroupName FOO_GROUP = new DefaultMenuGroupName("Foo");

    public static final MenuGroupName BAR_GROUP = new DefaultMenuGroupName("Bar");
