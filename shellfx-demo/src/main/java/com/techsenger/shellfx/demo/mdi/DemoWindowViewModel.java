 ...
 */
public class DemoWindowViewModel<C extends WindowComposer> extends AbstractWindowViewModel<C> {

    private final int contentIndex;

    public DemoWindowViewModel(WindowParams params, int contentIndex) {
        super(params);
