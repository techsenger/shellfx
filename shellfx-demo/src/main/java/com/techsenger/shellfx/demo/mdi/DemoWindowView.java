...
package com.techsenger.shellfx.demo.mdi;
 ...
 */
public class DemoWindowView<VM extends DemoWindowViewModel<?>> extends AbstractWindowView<VM> {
    ...
    private static Chart buildStackedAreaChart() {
        var xAxis = new NumberAxis();
        var yAxis = new NumberAxis();
    ...
    public DemoWindowView(VM viewModel) {
        super(viewModel);
    }
    ...
    protected void build() {
        ...
        var chart = switch (getViewModel().getContentIndex()) {
        ...
        getContentBox().getChildren().addAll(chart, hBox);
    }
    ...
    protected void addListeners() {
        ...
        alwaysOnTopCheckBox.selectedProperty()
                .addListener((ov, oldV, newV) -> getViewModel().alwaysOnTopProperty().set(newV));
        minimizableCheckBox.selectedProperty()
                .addListener((ov, oldV, newV) -> getViewModel().minimizableProperty().set(newV));
        maximizableCheckBox.selectedProperty()
                .addListener((ov, oldV, newV) -> getViewModel().maximizableProperty().set(newV));
        resizableCheckBox.selectedProperty()
                .addListener((ov, oldV, newV) -> getViewModel().resizableProperty().set(newV));
        closableCheckBox.selectedProperty()
                .addListener((ov, oldV, newV) -> getViewModel().closableProperty().set(newV));
    }
}
