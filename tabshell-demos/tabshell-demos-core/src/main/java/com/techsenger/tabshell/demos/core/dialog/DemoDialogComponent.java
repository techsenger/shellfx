 ...
 */
public class DemoDialogComponent extends AbstractDialogComponent<DemoDialogView> {

    public DemoDialogComponent(DemoDialogView view) {
        super(view);
    }

    @Override
    public Name getName() {
        return DemoComponentNames.DEMO_DIALOG;
    }
