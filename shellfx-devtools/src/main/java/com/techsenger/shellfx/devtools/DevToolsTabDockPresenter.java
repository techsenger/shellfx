...
import static com.techsenger.shellfx.devtools.DevToolsHostType.WINDOW;
import com.techsenger.shellfx.layout.dockhost.TabDockPresenter;
...
public class DevToolsTabDockPresenter<V extends DevToolsTabDockView>
    ...
    public DevToolsTabDockPresenter(V view, DevToolsTabDockParams params) {
        super(view, params);
