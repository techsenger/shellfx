 ...
 */
public class TabJediTermFxWidget extends JediTermFxWidget {

    private final Runnable showFind;

    public TabJediTermFxWidget(int columns, int lines, SettingsProvider settingsProvider, Runnable showFind) {
    ...
    protected TerminalPanel createTerminalPanel(SettingsProvider settingsProvider, StyleState styleState,
        ...
        return new TabTerminalPanel(settingsProvider, terminalTextBuffer, styleState);
    }
}
