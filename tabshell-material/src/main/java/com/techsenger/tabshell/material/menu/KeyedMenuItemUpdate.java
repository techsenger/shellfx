 ...
 */
public class KeyedMenuItemUpdate {

    public static class Builder extends AbstractChangeBuilder<KeyedMenuItemUpdate, Builder> {

        public Builder() {
            super(new KeyedMenuItemUpdate());
        }
    }
